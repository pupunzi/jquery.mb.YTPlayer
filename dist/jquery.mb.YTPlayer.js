	...
	jQuery.mbYTPlayer = {
		...
		buildPlayer: function (options) {
			...
			return this.each(function () {
				...
				/* Extend options */
				YTPlayer.opt = jQuery.extend(jQuery.mbYTPlayer.defaults, options, YTPlayer.property);
				...
				jQuery(document).one("YTAPIReady", function () {
					$YTPlayer.trigger("YTAPIReady");
				});

				$YTPlayer.one("YTAPIReady", function(e){
					YTPlayer = e.target;
		...
		checkForState: function () {
			...
			//console.debug("checkForState", YTPlayer.opt, YTPlayer.property)

			YTPlayer.opt = jQuery.extend(YTPlayer.opt, YTPlayer.property);
			...
			YTPlayer.getState = setInterval(function () {
				//  console.debug("YTPlayer.isReady", YTPlayer.isReady)
				if (!YTPlayer.isReady)
					return;
				...
				if ( YTPlayer.player.getPlayerState() > 0 && ( (parseFloat(YTPlayer.player.getDuration() - .5) < YTPlayer.player.getCurrentTime()) || ( stopAt > 0 && parseFloat(YTPlayer.player.getCurrentTime()) > stopAt ) )) {
					...
					//console.debug("loop:: ", data.loop, YTPlayer.player.loopTime, YTPlayer.player.getPlayerState());
